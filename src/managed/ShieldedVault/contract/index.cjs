...
class Contract {
      ...
      deposit: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('deposit',
                                      ...
                                      'ShieldedVault.compact line 11 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const result_0 = this._deposit_0(context, partialProofData, commitment_0);
      ...
      withdraw: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('withdraw',
                                      'argument 1 (as invoked from Typescript)',
                                      'ShieldedVault.compact line 15 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        const context = { ...contextOrig_0 };
  ...
  _findAuthPath_0(context, partialProofData, commitment_0) {
    ...
    if (!(typeof(result_0) === 'object' && result_0.leaf.buffer instanceof ArrayBuffer && result_0.leaf.BYTES_PER_ELEMENT === 1 && result_0.leaf.length === 32 && Array.isArray(result_0.path) && result_0.path.length === 10 && result_0.path.every((t) => typeof(t) === 'object' && typeof(t.sibling) === 'object' && typeof(t.sibling.field) === 'bigint' && t.sibling.field >= 0 && t.sibling.field <= __compactRuntime.MAX_FIELD && typeof(t.goes_left) === 'boolean'))) {
      __compactRuntime.type_error('findAuthPath',
                                  'return value',
                                  'ShieldedVault.compact line 8 char 1',
  ...
  _secretKey_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.type_error('secretKey',
                                  'return value',
                                  'ShieldedVault.compact line 9 char 1',
                                  'Bytes<32>',
                                  result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _deposit_0(context, partialProofData, commitment_0) {
    Contract._query(context,
                    partialProofData,
                    [
                     { idx: { cached: false,
      ...
      checkRoot(...args_0) {
        ...
        if (!(typeof(rt_0) === 'object' && typeof(rt_0.field) === 'bigint' && rt_0.field >= 0 && rt_0.field <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.type_error('checkRoot',
                                      'argument 1',
                                      'ShieldedVault.compact line 5 char 1',
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'ShieldedVault.compact line 6 char 1',
                                      'Bytes<32>',
                                      elem_0)
        }
        return _descriptor_3.fromValue(Contract._query(context,
