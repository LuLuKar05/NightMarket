...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      verify_kyc_status: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`verify_kyc_status: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('verify_kyc_status',
                                      'argument 1 (as invoked from Typescript)',
                                      'ZKKYCVerifier.compact line 7 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const result_0 = this._verify_kyc_status_0(context, partialProofData);
        partialProofData.output = { value: _descriptor_1.toValue(result_0), alignment: _descriptor_1.alignment() };
        return { result: result_0, context: context, proofData: partialProofData };
      }
    };
    this.impureCircuits = {
      verify_kyc_status: this.circuits.verify_kyc_status
    };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('verify_kyc_status', new __compactRuntime.ContractOperation());
    const context = {
  ...
  _verify_kyc_status_0(context, partialProofData) {
    return this._verify_kyc_0(this._kyc_proof_0(context, partialProofData));
  }
...
const _dummyContract = new Contract({ kyc_proof: (...args) => undefined });
const pureCircuits = {};
